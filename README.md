...
* **pdfmake.min.js**,
* **vfs_fonts.js** - default font definition (it contains FTFonts, you can however [use custom fonts instead](https://github.com/bpampuch/pdfmake/wiki/Custom-Fonts---client-side))
